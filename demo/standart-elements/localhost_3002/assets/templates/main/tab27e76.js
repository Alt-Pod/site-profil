(function() {
  ...
  this.HandlebarsTemplates["main/tab2"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  if (helper = helpers.product2) { stack1 = helper.call(depth0, options); }
  else { helper = (depth0 && depth0.product2); stack1 = typeof helper === functionType ? helper.call(depth0, options) : helper; }
  if (!helpers.product2) { stack1 = blockHelperMissing.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data}); }
  if(stack1 || stack1 === 0) { return stack1; }
  else { return ''; }
  });
  return this.HandlebarsTemplates["main/tab2"];
}).call(this);
