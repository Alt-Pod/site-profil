...
var PREV_MONTH_IMAGE = 'libs/calendar/calendar_prev.png';
var NEXT_MONTH_IMAGE = 'libs/calendar/calendar_next.png';
var PREV_YEAR_IMAGE = 'libs/calendar/prevp.gif';
var NEXT_YEAR_IMAGE = 'libs/calendar/nextp.gif';
...
function calendar_click(evt) {
  ...
  $(calendar.input_element).change() // Add by Anouar for live search event
  calendar_hide();
}
